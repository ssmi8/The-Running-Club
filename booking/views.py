...
from booking.models import (Booking, Home, Booking_detail)
import calendar
    ...
    if request.method == "GET":
        ...
        if booking_form.is_valid():
            ...
            messages.add_message(
                request, messages.SUCCESS, 'Booking successful')
            return render(
                request, 'booking_detail.html', {"booking": reservation})
        else:
